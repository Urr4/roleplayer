...
public class MinioTranscriptAdapter implements TranscriptStore {

    private final S3Client s3Client;
    private final S3Presigner presigner;
    private final String bucket;

    public MinioTranscriptAdapter(S3Client s3Client, S3Presigner presigner, @Value("${minio.bucket}") String bucket) {
